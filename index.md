...
1. Откройте нашего бота @vpn_easy_bot в Telegram через поиск по названию или по [ссылке](https://t.me/vpn_easy_bot?start=0) (к сожалению, стать пользователем нашего vpn сейчас можно только имея доступ в telegram).
...
2. Выберите "Вставить из буфера обмена"
3. Вставьте ключ
...
Если ранее вы не запускали используемое приложение, то у вас может появиться подобное сообщение, нажмите "Разрешить"

<img src="permission.jpg" width="40%" style="max-width:400px;">
